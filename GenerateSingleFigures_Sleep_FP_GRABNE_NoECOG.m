...
filtAch_mScarlet = filtfilt(sos2,g2,Ach_mScarlet);
...
% Blood Volume
ax8 = subplot(8,1,8);
p8 = plot((1:length(filtAch_mScarlet))/ProcData.notes.dsFs,filtAch_mScarlet,'color','r','LineWidth',1);
ylabel('\Delta F/F (Z)')
legend(p8,'mScarlet Ach')
xlim([0,ProcData.notes.trialDuration_sec])
set(gca,'TickLength',[0,0])
set(gca,'box','off')
axis tight
