function [SleepData] = CreateSleepData_2P_eLife2025(NREMsleepTime,REMsleepTime,modelName,SleepData)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:size(mergedDataFileIDs,1)
    ...
    [~,~,~,fileID,~,vesselID] = GetFileInfo2_2P_eLife2025(mergedDataFileID);
