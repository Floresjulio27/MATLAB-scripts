function [MScanData] = CalcPenVesselArea_2P_eLife2025(MScanData,fileID)
...
for f = 1:min(nframes,MScanData.notes.numberOfFrames)
    ...
    [MScanData.notes.pixelShift(:,f),~] = DftRegistration_2P_eLife2025(fftFirstFrame,fftRawHoldFrame,1);
