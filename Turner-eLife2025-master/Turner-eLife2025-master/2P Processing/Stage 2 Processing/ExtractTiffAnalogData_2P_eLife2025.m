function [MScanData] = ExtractTiffAnalogData_2P_eLife2025(MScanData, fileID)
...
[MScanData] = GetDiameterFromMovie_2P_eLife2025(MScanData,fileID);
try
    [MScanData] = FWHM_MovieProjection_2P_eLife2025(MScanData,[MScanData.notes.startframe,MScanData.notes.endframe]);
catch
...
try
    ...
    if strcmp(MScanData.notes.vesselType,'D') || strcmp(MScanData.notes.vesselType,'V')
        MScanData.data.vesselDiameter = RemoveMotion_2P_eLife2025(MScanData.data.tempVesselDiameter,MScanData.notes.vesselROI.modalFixedDiameter,2,0.3);
    else
        MScanData.data.vesselDiameter = RemoveMotion_2P_eLife2025(MScanData.data.tempVesselDiameter,MScanData.notes.vesselROI.modalFixedDiameter,2,0.5);
    end
    [diamPerc,S,f] = DiamPercPower_2P_eLife2025(MScanData.data.vesselDiameter,MScanData.notes.vesselROI.modalFixedDiameter,MScanData.notes.frameRate);
