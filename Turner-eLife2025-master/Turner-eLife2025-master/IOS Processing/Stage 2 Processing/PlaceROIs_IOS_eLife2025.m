function [ROIs] = PlaceROIs_IOS_eLife2025(animalID,fileID,ROIs,lensMag,imagingType,imagingWavelengths,imagingCamera)
%----------------------------------------------------------------------------------------------------------
...
if strcmp(imagingCamera,'PCO Edge 5.5') == true
    ...
    for aa = 1:size(procDataFileIDs)
        ...
        [~,procfileDate,~] = GetFileInfo_IOS_eLife2025(procDataFileID);
