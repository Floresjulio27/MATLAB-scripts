function [Rest] = GetRestData_IOS_eLife2025(ProcData)
%----------------------------------------------------------------------------------------------------------
...
binWhiskerAngle = LinkBinaryEvents_IOS_eLife2025(gt(modBinarizedWhiskers,0),[linkThresh breakThresh]*whiskerSamplingRate);
binForceSensor = LinkBinaryEvents_IOS_eLife2025(modBinarizedForceSensor,[linkThresh breakThresh]*forceSensorSamplingRate);
