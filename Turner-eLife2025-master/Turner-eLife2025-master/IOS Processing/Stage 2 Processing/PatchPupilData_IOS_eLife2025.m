function [ProcData] = PatchPupilData_IOS_eLife2025(RawData,ProcData)
%----------------------------------------------------------------------------------------------------------
...
[linkedBlinkIndex] = LinkBinaryEvents_IOS_eLife2025(gt(blinkNaNs,0),[RawData.notes.pupilCamSamplingRate,0]); % link greater than 1 second
...
[linkedDiffIndex] = LinkBinaryEvents_IOS_eLife2025(gt(diffIndex,0),[RawData.notes.pupilCamSamplingRate*2,0]);
% identify edges for interpolation
edgeFoundB = false;
xx = 1;
startEdgeB = [];
