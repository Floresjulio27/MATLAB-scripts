function [] = AnalyzePupilCrossCorrelation_Ephys_Handler_eLife2025(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_PupilCrossCorr_Ephys.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_PupilCrossCorr_Ephys] = AnalyzePupilCrossCorrelation_Ephys_eLife2025(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_PupilCrossCorr_Ephys);
        end
