function [] = AnalyzeIntrinsicSignals_Pulse_Handler_eLife2025(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_IntSig_Pulse.(groups{1,aa}),(animalIDs{1,bb})) == false
            [Results_IntSig_Pulse] = AnalyzeIntrinsicSignals_Pulse_eLife2025(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_IntSig_Pulse);
        end
