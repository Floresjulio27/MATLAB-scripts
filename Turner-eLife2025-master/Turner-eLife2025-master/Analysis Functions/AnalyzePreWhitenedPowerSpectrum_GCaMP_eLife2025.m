function [Results_PreWhitenedPowerSpec_GCaMP] = AnalyzePreWhitenedPowerSpectrum_GCaMP_eLife2025(animalID,group,set,rootFolder,delim,Results_PreWhitenedPowerSpec_GCaMP)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(hemispheres)
    ...
    for bb = 1:length(dataTypes)
        ...
        % save results
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Rest.S = restS;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Rest.f = restf;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Rest.sErr = restsErr;
        %% Alert
        ...
        if isempty(alertData) == false
            ...
            % save results
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.S = alertS;
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.f = alertf;
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.sErr = alertsErr;
        else
            % save results
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.S = [];
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.f = [];
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Alert.sErr = [];
        end
        %% Asleep
        ...
        if isempty(asleepData) == false
            ...
            % save results
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.S = asleepS;
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.f = asleepf;
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.sErr = asleepsErr;
        else
            % save results
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.S = [];
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.f = [];
            Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).Asleep.sErr = [];
        end
        %% All
        ...
        % save results
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).All.S = allS;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).All.f = allf;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).All.sErr = allsErr;
        %% NREM
        ...
        % save results
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).NREM.S = nremS;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).NREM.f = nremf;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).NREM.sErr = nremsErr;
        %% REM
        ...
        % save results
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).REM.S = remS;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).REM.f = remf;
        Results_PreWhitenedPowerSpec_GCaMP.(group).(animalID).(hemisphere).(dataType).REM.sErr = remsErr;
    end
end
% save data
cd([rootFolder delim 'Results_Turner'])
save('Results_PreWhitenedPowerSpec_GCaMP.mat','Results_PreWhitenedPowerSpec_GCaMP')
