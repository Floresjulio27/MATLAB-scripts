function [Results_ArousalStateProb_GCaMP] = AnalyzeArousalStateProbability_GCaMP_eLife2025(animalID,group,set,rootFolder,delim,Results_ArousalStateProb_GCaMP)
%----------------------------------------------------------------------------------------------------------
