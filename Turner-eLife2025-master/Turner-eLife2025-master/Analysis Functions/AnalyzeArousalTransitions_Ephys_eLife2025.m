function [Results_Transitions_Ephys] = AnalyzeArousalTransitions_Ephys_eLife2025(animalID,group,set,rootFolder,delim,Results_Transitions_Ephys)
%----------------------------------------------------------------------------------------------------------
...
save('Results_Transitions_Ephys.mat','Results_Transitions_Ephys')
