function [] = AnalyzePowerSpectrum_2P_Handler_eLife2025(rootFolder,delim,runFromStart)
%----------------------------------------------------------------------------------------------------------
...
for aa = 1:length(groups)
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_PowerSpec_2P.(groups{1,aa}),animalIDs{1,bb}) == false
            [Results_PowerSpec_2P] = AnalyzePowerSpectrum_2P_eLife2025(animalIDs{1,bb},groups{1,aa},set,rootFolder,delim,Results_PowerSpec_2P);
        end
