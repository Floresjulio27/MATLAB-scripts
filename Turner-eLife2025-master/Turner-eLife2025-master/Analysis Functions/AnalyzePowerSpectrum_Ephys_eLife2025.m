...
for aa = 1:length(hemispheres)
    ...
    for bb = 1:length(dataTypes)
        ...
        % save results
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Rest.S = restS;
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Rest.f = restf;
        ...
        if isempty(alertData) == false
            ...
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Alert.f = alertf;
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Alert.sErr = alertsErr;
        else
            % save results
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Alert.S = [];
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Alert.f = [];
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Alert.sErr = [];
        end
        %% Asleep
        ...
        if isempty(asleepData) == false
            ...
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Asleep.f = asleepf;
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Asleep.sErr = asleepsErr;
        else
            % save results
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Asleep.S = [];
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Asleep.f = [];
            Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).Asleep.sErr = [];
        end
        %% All
        ...
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).All.f = allf;
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).All.sErr = allsErr;
        %% NREM
        ...
        % save results
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).NREM.S = nremS;
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).NREM.f = nremf;
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).NREM.sErr = nremsErr;
        %% REM
        ...
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).REM.f = remf;
        Results_PowerSpec_Ephys.(group).(animalID).(hemisphere).(dataType).REM.sErr = remsErr;
    end
end
% save data
