function [AnalysisResults] = Fig1_S5_Movement_SST_Response_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,animalIDs)
...
legend([p1, p2, p3, p4],'CBV-LH','CBV-RH', 'SST LH', 'SST RH')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigureN,[dirpath 'Movement-FiberSignals-consolidated_CI']);
    set(summaryFigureN,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath 'Movement-FiberSignals-consolidated_CI'])
    close 
end
end
