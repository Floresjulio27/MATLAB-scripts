function [AnalysisResults] = Fig1_S3(rootFolder,saveFigs,delim,AnalysisResults)
...
for aa = 1:length(animalIDs)
    ...
    for cc = 1:length(whiskDataTypes)
        ...
        % left cortical
        data.(whiskDataType).LH.TRITC(:,aa) = AnalysisResults.(animalID).Whisk.LH.(whiskDataType).TRITC.TRITC;
        ...
        % right cortical
        data.(whiskDataType).RH.TRITC(:,aa) = AnalysisResults.(animalID).Whisk.RH.(whiskDataType).TRITC.TRITC;
...
for ee = 1:length(whiskDataTypes)
    ...
    data.(whiskDataType).TRITC = cat(2,data.(whiskDataType).LH.TRITC,data.(whiskDataType).RH.TRITC);
...
for ee = 1:length(whiskDataTypes)
    whiskDataType = whiskDataTypes{1,ee};
    data.(whiskDataType).meanTRITC = mean(data.(whiskDataType).TRITC,2);
    data.(whiskDataType).stdTRITC = std(data.(whiskDataType).TRITC,0,2);
...
hold on
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanHipMUA + data.ShortWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanHipMUA - data.ShortWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
hold on
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanHipMUA + data.IntermediateWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanHipMUA - data.IntermediateWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
hold on
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanHipMUA + data.LongWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanHipMUA - data.LongWhisks.stdHipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
%% [1-S3m] brief whisks TRITC
ax13 = subplot(6,3,13);
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanTRITC,'color',colors('indian red'),'LineWidth',1);
hold on
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanTRITC + data.ShortWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanTRITC - data.ShortWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
...
%% [1-S3n] moderate whisks TRITC
ax14 = subplot(6,3,14);
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanTRITC,'color',colors('indian red'),'LineWidth',1);
hold on
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanTRITC + data.IntermediateWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanTRITC - data.IntermediateWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
...
%% [1-S3o] extended whisks TRITC
ax15 = subplot(6,3,15);
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanTRITC,'color',colors('indian red'),'LineWidth',1);
hold on
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanTRITC + data.LongWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanTRITC - data.LongWhisks.stdTRITC,'color',colors('indian red'),'LineWidth',0.25)
...
ax16 = subplot(6,3,16);
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanGCaMP7s,'color',colors('army green'),'LineWidth',1);
hold on
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanGCaMP7s + data.ShortWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.meanGCaMP7s - data.ShortWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
ax17 = subplot(6,3,17);
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanGCaMP7s,'color',colors('army green'),'LineWidth',1);
hold on
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanGCaMP7s + data.IntermediateWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.meanGCaMP7s - data.IntermediateWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
ax18 = subplot(6,3,18);
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanGCaMP7s,'color',colors('army green'),'LineWidth',1);
hold on
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanGCaMP7s + data.LongWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.LongWhisks.meanTimeVector,data.LongWhisks.meanGCaMP7s - data.LongWhisks.stdGCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
%     % text values
%     disp('======================================================================================================================')
%     disp('[1-S3] Text values for gamma/TRITC changes')
%     disp('======================================================================================================================')
%     disp('----------------------------------------------------------------------------------------------------------------------')
%      % cortical MUA/LFP
...
%     % TRITC
%     [~,index] = max(data.ShortWhisks.meanTRITC);
%     disp(['Brief whisk [TRITC]: ' num2str(round(data.ShortWhisks.meanTRITC(index),1)) ' +/- ' num2str(round(data.ShortWhisks.stdTRITC(index),1))]); disp(' ')
%     [~,index] = max(data.IntermediateWhisks.meanTRITC);
%     disp(['Moderate whisk [TRITC]: ' num2str(round(data.IntermediateWhisks.meanTRITC(index),1)) ' +/- ' num2str(round(data.IntermediateWhisks.stdTRITC(index),1))]); disp(' ')
%     [~,index] = max(data.LongWhisks.meanTRITC);
%     disp(['Extended whisk [TRITC]: ' num2str(round(data.LongWhisks.meanTRITC(index),1)) ' +/- ' num2str(round(data.LongWhisks.stdTRITC(index),1))]); disp(' ')
%     % R/R
