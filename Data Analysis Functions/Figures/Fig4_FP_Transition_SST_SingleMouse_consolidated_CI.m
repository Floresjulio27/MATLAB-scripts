function [AnalysisResults] = Fig4_FP_Transition_SST_SingleMouse_consolidated_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,IOSanimalIDs)
...
legend([p1,p4,p2,p3],'CBV S1BF','CBV PFC','SST PFC','SST S1BF','Location','northeast','FontSize',5)
xlim([-30,30])
title('Awake to NREM')
set(gca,'box','off')
ax1.YAxis(1).Color = 'k';
...
% % ylabel({'\DeltaF/F (%) NE'},'rotation',-90,'VerticalAlignment','bottom')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure_D,[dirpath 'Transition_CBV_vs_GFP_Sleep_CI_SST']);
    set(summaryFigure_D,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath 'Transition_CBV_vs_GFP_Sleep_CI_SST'])
end
close
