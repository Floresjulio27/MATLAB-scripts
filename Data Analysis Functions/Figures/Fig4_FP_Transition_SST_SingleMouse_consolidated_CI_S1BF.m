function [AnalysisResults] = Fig4_FP_Transition_SST_SingleMouse_consolidated_CI_S1BF(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,IOSanimalIDs)
...
%% Awake to NREM
% I add - CI95. Makes more sense? Need to ask 
% Blood Volume and SST Ca2+ activity in S1BF
ax1 = subplot(2,2,1);
...
legend([p1,p3],'CBV S1BF','SST S1BF','Location','northeast','FontSize',5)
xlim([-30,30])
title('Awake to NREM')
set(gca,'box','off')
ax1.YAxis(1).Color = 'k';
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure_D,[dirpath ManipulationType '_' 'Transition_CBV_vs_GFP_Sleep_CI_SST_S1BF']);
    set(summaryFigure_D,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath ManipulationType '_' 'Transition_CBV_vs_GFP_Sleep_CI_SST_SIBF'])
end
close
