function [AnalysisResults] = AnalyzeAwakeProbability_Test(animalID,saveFigs,rootFolder,AnalysisResults)
...
%             a61 = a61 + 1;
    ...
    if strcmp(saveFigs,'y') == true
        ...
        savefig(hypFig,[dirpath animalID '_HypnogramTest']);
        close(hypFig)
    end
    % save results
