function [procNeuroPower,procNeuroSignal,neuroFs] = ProcessNeuro_FP_EEG_Signal(RawData,expectedLength,neurType,neuralFieldName)
...
if ismember(neurType,[{'MUA'},{'EEG'},{'Gam'},{'Beta'},{'Alpha'},{'Theta'},{'Delta'}])
    ...
    procNeuroSignal = resample(filtNeuro,neuroFs,analogFs);
end
