...
% zap;
function StageTwoProcessing_FP_EEG()
...
TDTFiberPhotometry_bilateralGFP(filelocation,rawDataFiles)
...
TemplateMatchFiberData_FP_EEG(fiberDataFileID,rawDataFileIDs)
...
ProcessRawDataFiles_FP_EEG(rawDataFileIDs)
%% fin.
