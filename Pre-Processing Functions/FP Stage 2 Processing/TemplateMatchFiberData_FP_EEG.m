function [] = TemplateMatchFiberData_FP_EEG(FiberDataFileIDs,rawDataFileIDs)
...
for aa = 1:size(rawDataFileIDs,1)
    ...
    tdtsubfields = {'RhodamineCorrection','dF'};
    ...
    labviewFields = {'EEG_LH','EEG_RH','EMG','forceSensor','stimulations'};
