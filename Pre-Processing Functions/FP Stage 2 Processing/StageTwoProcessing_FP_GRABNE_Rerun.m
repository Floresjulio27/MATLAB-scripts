...
% zap;
function StageTwoProcessing_FP_GRABNE_Rerun()
...
% TDTFiberPhotometry_bilateralGRABNE_Rerun_Test(FiberDataFiles)
...
% TemplateMatchFiberData_FP_GRABNE(fiberDataFileID,rawDataFileIDs)
...
% Redo the whiskers
ProcessWhiskers_FP_GRABNE(rawDataFileIDs)
%% fin.
