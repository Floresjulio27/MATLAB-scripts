function [] = TemplateMatchFiberData_FP(FiberDataFileIDs,rawDataFileIDs)
...
for aa = 1:size(rawDataFileIDs,1)
    ...
    % remove old fiber data and replace with new fiber data
    ...
    tdtsubfields = {'TRITCCorrection','dF'};
