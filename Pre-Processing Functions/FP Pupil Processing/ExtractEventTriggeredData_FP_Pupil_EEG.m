function [EventData] = ExtractEventTriggeredData_FP_Pupil_EEG(procdataFiles,dataTypes)
...
for a = 1:length(dataTypes)
    ...
    elseif strcmp(dataType,'Pupil') == true
        ...
        subDataTypes = {'deltaBandPower','thetaBandPower','alphaBandPower','betaBandPower','gammaBandPower','EEGPower','deltaBandSignal','thetaBandSignal','alphaBandSignal','betaBandSignal','gammaBandSignal','EEGSignal'};
