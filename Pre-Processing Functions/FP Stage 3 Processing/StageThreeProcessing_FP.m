% function StageThreeProcessing_FP()
...
dataTypes = {'Rhodamine','GCaMP7s','cortical_LH','cortical_RH','hippocampus','EMG'};
...
[RestingBaselines] = CalculateManualRestingBaselinesTimeIndeces_FP_Shak(); % Don't redo  the baseline selection
...
[RestData] = NormBehavioralDataStruct_FP_Shak(RestData,RestingBaselines,updatedBaselineType);
save([animalID '_RestData.mat'],'RestData','-v7.3')
[EventData] = NormBehavioralDataStruct_FP_Shak(EventData,RestingBaselines,updatedBaselineType);
