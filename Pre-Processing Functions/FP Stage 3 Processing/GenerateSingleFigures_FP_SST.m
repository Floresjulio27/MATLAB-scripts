function [figHandle,ax1,ax2,ax3,ax4,ax5,ax6] = GenerateSingleFigures_FP_SST(procDataFileID,saveFigs)
...
ylabel('\delta F/F')
legend([s1,s2,s3,s4,p8,p6],'LSol','RSol','AudSol','OptoStim','SST RH', 'CBV RH')
xlim([0,ProcData.notes.trialDuration_sec])
set(gca,'TickLength',[0,0])
set(gca,'Xticklabel',[])
set(gca,'box','off')
