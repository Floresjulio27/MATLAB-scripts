...
% function GenerateFigures_Proposal()
...
p5 = plot((1:length(filteredpupildiameter))/resample_rate,filteredpupildiameter,'color',colors('dark candy apple red'),'LineWidth',1);
ylabel('Diameter (Z)')
...
% Axes properties
linkaxes([ax1,ax2,ax3,ax4],'x') %,ax8 ,ax7
...
ax1Pos(4) = ax1Pos(4)+0.07;
ax2Pos(4) = ax2Pos(4)+0.07;
ax3Pos(4) = ax3Pos(4)+0.07;
ax4Pos(4) = ax4Pos(4)+0.07;
% ax5Pos(4) = ax5Pos(4)+0.08;
% ax6Pos(4) = ax6Pos(4)+0.08;
