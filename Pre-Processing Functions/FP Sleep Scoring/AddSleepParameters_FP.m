function [] = AddSleepParameters_FP(procDataFileIDs,RestingBaselines,baselineType,NBins)
...
for a = 1:size(procDataFileIDs,1)
    ...
    LH_NormGCaMP7s = (LH_GCaMP7s - RestingBaselines.(baselineType).GCaMP7s.LH.(strDay).mean)/RestingBaselines.(baselineType).GCaMP7s.LH.(strDay).std;
    RH_NormGCaMP7s = (RH_GCaMP7s - RestingBaselines.(baselineType).GCaMP7s.RH.(strDay).mean)/RestingBaselines.(baselineType).GCaMP7s.RH.(strDay).std;
    ...
    for RhodamineBins = 1:NBins
        if RhodamineBins == 1
            LH_tempGCaMP7sStruct(RhodamineBins,1) = {LH_NormGCaMP7s(RhodamineBins:150)};  % Samples 1 to 150
            RH_tempGCaMP7sStruct(RhodamineBins,1) = {RH_NormGCaMP7s(RhodamineBins:150)};
            ...
            LH_tempGCaMP7sStruct(RhodamineBins,1) = {LH_NormGCaMP7s((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};  % Samples 151 to 300, etc...
            RH_tempGCaMP7sStruct(RhodamineBins,1) = {RH_NormGCaMP7s((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};
