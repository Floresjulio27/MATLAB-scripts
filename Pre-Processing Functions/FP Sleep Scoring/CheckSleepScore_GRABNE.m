% function CheckSleepScore_GRABNE()
...
for a = 2:size(procDataFileIDs,1)
    ...
    [figHandle,ax1,ax2,ax3,ax4,ax6,ax7] =  GenerateSingleFigures_Sleep_FP_GRABNE_CheckSleepFinal(procDataFileID,saveFig); % plot the sleep scores.
    close all
    %{
