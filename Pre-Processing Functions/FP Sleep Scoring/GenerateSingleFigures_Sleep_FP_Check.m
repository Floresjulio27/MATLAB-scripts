function [figHandle,ax1,ax2,ax3,ax5,ax6] = GenerateSingleFigures_Sleep_FP_Check(procDataFileID,saveFigs)
...
% Sleep Score
ax4 = subplot(7,1,4);
s1 = plot(SleepDummy',AwakeStage,'|','LineWidth',0.05,'MarkerSize',20,'MarkerFaceColor','k','MarkerEdgeColor','k');
hold on
s2 = plot(SleepDummy',NREMStage,'|','LineWidth',0.05,'MarkerSize',20,'MarkerFaceColor','b','MarkerEdgeColor','b');
s3 = plot(SleepDummy',REMStage,'|','LineWidth',0.05,'MarkerSize',20,'MarkerFaceColor','r','MarkerEdgeColor','r');
