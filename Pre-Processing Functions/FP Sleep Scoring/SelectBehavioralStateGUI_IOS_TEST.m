function varargout = SelectBehavioralStateGUI_IOS_TEST(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_LayoutFcn',  @SelectBehavioralStateGUI_IOS_LayoutFcn, ...
    'gui_Callback',   []);
...
function h1 = SelectBehavioralStateGUI_IOS_LayoutFcn(policy)
...
load SelectBehavioralStateGUI_IOS.mat
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', 'C:\Users\klt8\OneDrive - The Pennsylvania State University\Documents\Github Repositories\Data-Analysis\Pre-Processing Functions\IOS Sleep Scoring\SelectBehavioralStateGUI_IOS.m', ...
    'lastFilename', 'C:\Users\klt8\OneDrive - The Pennsylvania State University\Documents\Github Repositories\Data-Analysis\Pre-Processing Functions\IOS Sleep Scoring\SelectBehavioralStateGUI_IOS.fig');
...
'MenuBar','none',...
'Name','SelectBehavioralStateGUI_IOS',...
'NumberTitle','off',...
...
'Callback',@(hObject,eventdata)SelectBehavioralStateGUI_IOS('togglebutton1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
...
'Callback',@(hObject,eventdata)SelectBehavioralStateGUI_IOS('togglebutton2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Tag','togglebutton2',...
'FontSize',20,...
...
'Callback',@(hObject,eventdata)SelectBehavioralStateGUI_IOS('togglebutton3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','togglebutton3',...
'FontSize',20,...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
