function [] = CreateTrainingDataSet_FP_Shak(procDataFileIDs,NBins)
...
for a = 1:size(procDataFileIDs,1)
    ...
    if ~exist(trainingDataFileID,'file') 
        ...
        saveFigs = 'n';
        [figHandle,ax1,ax2,ax3,ax5,ax6] = GenerateSingleFigures_Sleep_FP_Shak(procDataFileID,saveFigs);
...
%             delete(rightEdge5)
        ...
        close(figHandle)
        traininglables = categorical(behavioralState);
        save(trainingDataFileID, 'traininglables')
    else
