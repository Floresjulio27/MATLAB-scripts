function [ScoringResults] = PredictBehaviorEvents_FP_Shak(animalID,startingDirectory,baselineDirectory,modelDataFileIDs,modelName)
...
if strcmp(notManual,'y') == true
    ...
    scoringTable = table2array(joinedTable);
