function [] = AddSleepParameters_FP_GRABNE(procDataFileIDs,RestingBaselines,baselineType,NBins)
...
%     ProcData.sleep.parameters = rmfield(ProcData.sleep.parameters,'EMG');
    ...
    Ach_GFP = ProcData.data.GFP.Ach;
    NE_GFP = ProcData.data.GFP.NE; 
    Ach_Rhodamine = ProcData.data.Rhodamine.Ach;
    NE_Rhodamine = ProcData.data.Rhodamine.NE;

    Ach_NormRhodamine = (Ach_Rhodamine - RestingBaselines.(baselineType).Rhodamine.Ach.(strDay).mean)/RestingBaselines.(baselineType).Rhodamine.Ach.(strDay).std;
    ...
    Ach_NormGFP = (Ach_GFP - RestingBaselines.(baselineType).GFP.Ach.(strDay).mean)/RestingBaselines.(baselineType).GFP.Ach.(strDay).std;
    NE_NormGFP = (NE_GFP - RestingBaselines.(baselineType).GFP.NE.(strDay).mean)/RestingBaselines.(baselineType).GFP.NE.(strDay).std;

    Ach_tempGFPStruct = cell(NBins,1);
    NE_tempGFPStruct = cell(NBins,1);  
    RhodamineAch_tempRhodamineStruct = cell(NBins,1);
    RhodamineNE_tempRhodamineStruct = cell(NBins,1);

    for RhodamineBins = 1:NBins
        if RhodamineBins == 1
            Ach_tempGFPStruct(RhodamineBins,1) = {Ach_NormGFP(RhodamineBins:150)};  % Samples 1 to 150
            NE_tempGFPStruct(RhodamineBins,1) = {NE_NormGFP(RhodamineBins:150)};

            RhodamineAch_tempRhodamineStruct(RhodamineBins,1) = {Ach_NormRhodamine(RhodamineBins:150)};  % Samples 1 to 150
            RhodamineNE_tempRhodamineStruct(RhodamineBins,1) = {NE_NormRhodamine(RhodamineBins:150)};
        else
            Ach_tempGFPStruct(RhodamineBins,1) = {Ach_NormGFP((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};  % Samples 151 to 300, etc...
            NE_tempGFPStruct(RhodamineBins,1) = {NE_NormGFP((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};
            RhodamineAch_tempRhodamineStruct(RhodamineBins,1) = {Ach_NormRhodamine((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};  % Samples 151 to 300, etc...
    ...
    ProcData.sleep.parameters.GFP.Ach = Ach_tempGFPStruct;
    ProcData.sleep.parameters.GFP.NE = NE_tempGFPStruct;
    ProcData.sleep.parameters.Rhodamine.Ach = RhodamineAch_tempRhodamineStruct;
    ...
    for RhodamineBins = 1:NBins
        if RhodamineBins == 1
            Z_Ach_tempGFPStruct(RhodamineBins,1) = {Z_Ach_NormGFP(RhodamineBins:150)};  % Samples 1 to 150
            Z_NE_tempGFPStruct(RhodamineBins,1) = {Z_NE_NormGFP(RhodamineBins:150)};

            RhodamineZ_Ach_tempRhodamineStruct(RhodamineBins,1) = {Z_Ach_NormRhodamine(RhodamineBins:150)};  % Samples 1 to 150
            RhodamineZ_NE_tempRhodamineStruct(RhodamineBins,1) = {Z_NE_NormRhodamine(RhodamineBins:150)};
        else
            Z_Ach_tempGFPStruct(RhodamineBins,1) = {Z_Ach_NormGFP((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};  % Samples 151 to 300, etc...
            Z_NE_tempGFPStruct(RhodamineBins,1) = {Z_NE_NormGFP((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};
            RhodamineZ_Ach_tempRhodamineStruct(RhodamineBins,1) = {Z_Ach_NormRhodamine((((150*(RhodamineBins-1)) + 1)):(150*RhodamineBins))};  % Samples 151 to 300, etc...
