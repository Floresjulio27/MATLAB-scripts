function [figHandle,ax1,ax2,ax3,ax4,ax6,ax7] = GenerateSingleFigures_Sleep_FP_GRABNE_CheckSleep(procDataFileID,saveFigs)
...
axis tight
hold off
% use this if you have a Left Cortical Electrode
%{
