function [AnalysisResults] = AnalyzeBehavioralDistributions_GRABNE(animalID,rootFolder,AnalysisResults,firstHrs)
...
if any(strcmp(animalIDs,animalID))
    ...
    forestModelID = [animalID '_Manual_ScoringResults.mat'];
