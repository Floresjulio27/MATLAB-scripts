function [AnalysisResults] = Fig1_S2_contra(rootFolder,saveFigs,delim,AnalysisResults)
...
FPanimalIDs = {'T281','T282','T284','T285'};
...
for aa = 1:length(FPanimalIDs)
    ...
    for bb = 1:length(dataTypes)
        ...
        for dd = 1:length(solenoidNames)
            ...
            data.(dataType).(solenoidName).TRITC(:,aa) = AnalysisResults.(animalID).Stim.(dataType).(solenoidName).TRITC.TRITC;
...
data.Contra.TRITC = cat(2,data.LH.RPadSol.TRITC,data.RH.LPadSol.TRITC);
...
data.Ipsi.TRITC = cat(2,data.LH.LPadSol.TRITC,data.RH.RPadSol.TRITC);
...
data.Auditory.TRITC = cat(2,data.LH.AudSol.TRITC,data.RH.AudSol.TRITC);
...
for ff = 1:length(compDataTypes)
    ...
    data.(compDataType).mean_TRITC = mean(data.(compDataType).TRITC,2);
    data.(compDataType).std_TRITC = std(data.(compDataType).TRITC,0,2);
...
hold on
plot(data.Contra.mean_timeVector,data.Contra.mean_HipMUA + data.Contra.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.Contra.mean_timeVector,data.Contra.mean_HipMUA - data.Contra.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
hold on
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_HipMUA + data.Ipsi.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_HipMUA - data.Ipsi.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
hold on
plot(data.Auditory.mean_timeVector,data.Auditory.mean_HipMUA + data.Auditory.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
plot(data.Auditory.mean_timeVector,data.Auditory.mean_HipMUA - data.Auditory.std_HipMUA,'color',colors('battleship grey'),'LineWidth',0.25)
...
%% [1-S2m] TRITC contra stim
ax13 = subplot(6,3,13);
plot(data.Contra.mean_timeVector,data.Contra.mean_TRITC,'color',colors('indian red'),'LineWidth',1)
hold on
plot(data.Contra.mean_timeVector,data.Contra.mean_TRITC + data.Contra.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.Contra.mean_timeVector,data.Contra.mean_TRITC - data.Contra.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
...
%% [1-S2n] TRITC ispi stim
ax14 = subplot(6,3,14);
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_TRITC,'color',colors('indian red'),'LineWidth',1)
hold on
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_TRITC + data.Ipsi.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_TRITC - data.Ipsi.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
...
%% [1-S2o] TRITC auditory stim
ax15 = subplot(6,3,15);
plot(data.Auditory.mean_timeVector,data.Auditory.mean_TRITC,'color',colors('indian red'),'LineWidth',1)
hold on
plot(data.Auditory.mean_timeVector,data.Auditory.mean_TRITC + data.Auditory.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
plot(data.Auditory.mean_timeVector,data.Auditory.mean_TRITC - data.Auditory.std_TRITC,'color',colors('indian red'),'LineWidth',0.25)
...
ax16 = subplot(6,3,16);
plot(data.Contra.mean_timeVector,data.Contra.mean_GCaMP7s,'color',colors('army green'),'LineWidth',1)
hold on
plot(data.Contra.mean_timeVector,data.Contra.mean_GCaMP7s + data.Contra.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.Contra.mean_timeVector,data.Contra.mean_GCaMP7s - data.Contra.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
ax17 = subplot(6,3,17);
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_GCaMP7s,'color',colors('army green'),'LineWidth',1)
hold on
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_GCaMP7s + data.Ipsi.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.Ipsi.mean_timeVector,data.Ipsi.mean_GCaMP7s - data.Ipsi.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
ax18 = subplot(6,3,18);
plot(data.Auditory.mean_timeVector,data.Auditory.mean_GCaMP7s,'color',colors('army green'),'LineWidth',1)
hold on
plot(data.Auditory.mean_timeVector,data.Auditory.mean_GCaMP7s + data.Auditory.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
plot(data.Auditory.mean_timeVector,data.Auditory.mean_GCaMP7s - data.Auditory.std_GCaMP7s,'color',colors('army green'),'LineWidth',0.25)
...
%     % text values
%     disp('======================================================================================================================')
%     disp('[1-S2] Text values for gamma/TRITC/reflectance changes')
%     disp('======================================================================================================================')
%     disp('----------------------------------------------------------------------------------------------------------------------')
%     % cortical MUA/LFP
...
%     % TRITC
%     [~,index] = max(data.Contra.mean_TRITC);
%     disp(['Contra stim [TRITC]: ' num2str(round(data.Contra.mean_TRITC(index),1)) ' +/- ' num2str(round(data.Contra.std_TRITC(index),1))]); disp(' ')
%     [~,index] = max(data.Ipsi.mean_TRITC);
%     disp(['Ipsil stim [TRITC]: ' num2str(round(data.Ipsi.mean_TRITC(index),1)) ' +/- ' num2str(round(data.Ipsi.std_TRITC(index),1))]); disp(' ')
%     [~,index] = max(data.Auditory.mean_TRITC);
%     disp(['Audit stim [TRITC]: ' num2str(round(data.Auditory.mean_TRITC(index),1)) ' +/- ' num2str(round(data.Auditory.std_TRITC(index),1))]); disp(' ')
%     % GCaMP7s
