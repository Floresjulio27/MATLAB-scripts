function [AnalysisResults] = Fig1_S4_FP_No_REM_Rest(rootFolder,saveFigs,delim,AnalysisResults)
...
behavFields = {'Whisk','Stim','NREM','Rest'};
...
% TRITC
tableSize = cat(1,data.TRITC.Rest.animalID,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID,data.TRITC.NREM.animalID);
...
TRITC_meanTable.Mouse = cat(1,data.TRITC.Rest.animalID,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID,data.TRITC.NREM.animalID);
TRITC_meanTable.Hemisphere = cat(1,data.TRITC.Rest.hemisphere,data.TRITC.Stim.hemisphere,data.TRITC.Whisk.hemisphere,data.TRITC.NREM.hemisphere);
TRITC_meanTable.Behavior = cat(1,data.TRITC.Rest.behavior,data.TRITC.Stim.behavior,data.TRITC.Whisk.behavior,data.TRITC.NREM.behavior);
TRITC_meanTable.Mean = cat(1,data.TRITC.Rest.catmean,data.TRITC.Stim.catmean,data.TRITC.Whisk.catmean,data.TRITC.NREM.catmean);
...
% GCaMP7s
tableSize = cat(1,data.GCaMP7s.Rest.animalID,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID,data.GCaMP7s.NREM.animalID);
...
GCaMP7s_meanTable.Mouse = cat(1,data.GCaMP7s.Rest.animalID,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID,data.GCaMP7s.NREM.animalID);
GCaMP7s_meanTable.Hemisphere = cat(1,data.GCaMP7s.Rest.hemisphere,data.GCaMP7s.Stim.hemisphere,data.GCaMP7s.Whisk.hemisphere,data.GCaMP7s.NREM.hemisphere);
GCaMP7s_meanTable.Behavior = cat(1,data.GCaMP7s.Rest.behavior,data.GCaMP7s.Stim.behavior,data.GCaMP7s.Whisk.behavior,data.GCaMP7s.NREM.behavior);
GCaMP7s_meanTable.Mean = cat(1,data.GCaMP7s.Rest.catmean,data.GCaMP7s.Stim.catmean,data.GCaMP7s.Whisk.catmean,data.GCaMP7s.NREM.catmean);
...
s1=scatter(xInds*2,data.TRITC.Whisk.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorWhisk,'jitter','on','jitterAmount',0.25);
hold on
e1 = errorbar(2,data.TRITC.Whisk.meanmean,data.TRITC.Whisk.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;

s2=scatter(xInds*3,data.TRITC.Stim.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorStim,'jitter','on','jitterAmount',0.25);
e2 = errorbar(3,data.TRITC.Stim.meanmean,data.TRITC.Stim.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 10;
e2.CapSize = 10;
...
ax4 = subplot(1,2,2);
xInds = ones(1,length(FP_animalIDs)*2);
scatter(xInds*2,data.GCaMP7s.Whisk.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorWhisk,'jitter','on','jitterAmount',0.25);
hold on
e1 = errorbar(2,data.GCaMP7s.Whisk.meanmean,data.GCaMP7s.Whisk.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;

scatter(xInds*3,data.GCaMP7s.Stim.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorStim,'jitter','on','jitterAmount',0.25);
e2 = errorbar(3,data.GCaMP7s.Stim.meanmean,data.GCaMP7s.Stim.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 10;
e2.CapSize = 10;
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure,[dirpath 'Fig1-S4-NoREMRest']);
    set(summaryFigure,'PaperPositionMode','auto');
    print('-painters','-dpdf','-bestfit',[dirpath 'Fig1-S4-NoREMRest'])
    close 
    %% Text diary
