function [AnalysisResults] = Fig1_S4_FP_No_Sleep(rootFolder,saveFigs,delim,AnalysisResults)
...
% TRITC
tableSize = cat(1,data.TRITC.Rest.animalID,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID);
...
TRITC_meanTable.Mouse = cat(1,data.TRITC.Rest.animalID,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID);
TRITC_meanTable.Hemisphere = cat(1,data.TRITC.Rest.hemisphere,data.TRITC.Stim.hemisphere,data.TRITC.Whisk.hemisphere);
TRITC_meanTable.Behavior = cat(1,data.TRITC.Rest.behavior,data.TRITC.Stim.behavior,data.TRITC.Whisk.behavior);
TRITC_meanTable.Mean = cat(1,data.TRITC.Rest.catmean,data.TRITC.Stim.catmean,data.TRITC.Whisk.catmean);
...
% GCaMP7s
tableSize = cat(1,data.GCaMP7s.Rest.animalID,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID);
...
GCaMP7s_meanTable.Mouse = cat(1,data.GCaMP7s.Rest.animalID,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID);
GCaMP7s_meanTable.Hemisphere = cat(1,data.GCaMP7s.Rest.hemisphere,data.GCaMP7s.Stim.hemisphere,data.GCaMP7s.Whisk.hemisphere);
GCaMP7s_meanTable.Behavior = cat(1,data.GCaMP7s.Rest.behavior,data.GCaMP7s.Stim.behavior,data.GCaMP7s.Whisk.behavior);
GCaMP7s_meanTable.Mean = cat(1,data.GCaMP7s.Rest.catmean,data.GCaMP7s.Stim.catmean,data.GCaMP7s.Whisk.catmean);
...
legend([s3,s1,s2],'Rest','Whisk','Stim','Location','best')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
axis tight
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure,[dirpath 'Fig1-S4-NoSleep']);
    set(summaryFigure,'PaperPositionMode','auto');
    print('-painters','-dpdf','-bestfit',[dirpath 'Fig1-S4-NoSleep'])
    close 
    %% Text diary
