function [AnalysisResults] = Fig1_S4_FP_No_REM(rootFolder,saveFigs,delim,AnalysisResults)
...
% TRITC
tableSize = cat(1,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID,data.TRITC.NREM.animalID);
...
TRITC_meanTable.Mouse = cat(1,data.TRITC.Stim.animalID,data.TRITC.Whisk.animalID,data.TRITC.NREM.animalID);
TRITC_meanTable.Hemisphere = cat(1,data.TRITC.Stim.hemisphere,data.TRITC.Whisk.hemisphere,data.TRITC.NREM.hemisphere);
TRITC_meanTable.Behavior = cat(1,data.TRITC.Stim.behavior,data.TRITC.Whisk.behavior,data.TRITC.NREM.behavior);
TRITC_meanTable.Mean = cat(1,data.TRITC.Stim.catmean,data.TRITC.Whisk.catmean,data.TRITC.NREM.catmean);
...
% GCaMP7s
tableSize = cat(1,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID,data.GCaMP7s.NREM.animalID);
...
GCaMP7s_meanTable.Mouse = cat(1,data.GCaMP7s.Stim.animalID,data.GCaMP7s.Whisk.animalID,data.GCaMP7s.NREM.animalID);
GCaMP7s_meanTable.Hemisphere = cat(1,data.GCaMP7s.Stim.hemisphere,data.GCaMP7s.Whisk.hemisphere,data.GCaMP7s.NREM.hemisphere);
GCaMP7s_meanTable.Behavior = cat(1,data.GCaMP7s.Stim.behavior,data.GCaMP7s.Whisk.behavior,data.GCaMP7s.NREM.behavior);
GCaMP7s_meanTable.Mean = cat(1,data.GCaMP7s.Stim.catmean,data.GCaMP7s.Whisk.catmean,data.GCaMP7s.NREM.catmean);
...
s1=scatter(xInds*1,data.TRITC.Whisk.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorWhisk,'jitter','on','jitterAmount',0.25);
hold on
e1 = errorbar(1,data.TRITC.Whisk.meanmean,data.TRITC.Whisk.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;
...
s4=scatter(xInds*3,data.TRITC.NREM.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorNREM,'jitter','on','jitterAmount',0.25);
e4 = errorbar(3,data.TRITC.NREM.meanmean,data.TRITC.NREM.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 10;
e4.CapSize = 10;
...
legend([s1,s2,s4],'Whisk','Stim','NREM','Location','best')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
axis tight
...
ax4 = subplot(1,2,2);
xInds = ones(1,length(FP_animalIDs)*2);
scatter(xInds*1,data.GCaMP7s.Whisk.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorWhisk,'jitter','on','jitterAmount',0.25);
hold on
e1 = errorbar(1,data.GCaMP7s.Whisk.meanmean,data.GCaMP7s.Whisk.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;
...
scatter(xInds*3,data.GCaMP7s.NREM.catmean,75,'MarkerEdgeColor','k','MarkerFaceColor',colorNREM,'jitter','on','jitterAmount',0.25);
e4 = errorbar(3,data.GCaMP7s.NREM.meanmean,data.GCaMP7s.NREM.stdmean,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 10;
e4.CapSize = 10;
