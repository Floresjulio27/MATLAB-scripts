...
% zap;
function StageTwoProcessing_FP_Rerun()
...
disp('Analyzing Block [1] fiberphotometry data.'); disp(' ')
...
% TDTFiberPhotometry_bilateralGCaMP7s_OnlyHemodynamicCorrect(filelocation,FiberDataFiles) % just to redo the hemodynamic correction
TDTFiberPhotometry_bilateralGCaMP7s_Rerun(filelocation,FiberDataFiles)
% TDTFiberPhotometry_bilateralGCaMP7s(filelocation,FiberDataFiles)
