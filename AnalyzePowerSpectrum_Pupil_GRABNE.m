...
for aa = 1:length(dataTypes)
    ...
    if strcmp(dataType,'Ach_Rhodamine') == true
        ...
        restData = RestData.Rhodamine.Ach.data(combRestLogical,:);
    elseif strcmp(dataType,'NE_Rhodamine') == true
        [restLogical] = FilterEvents_IOS(RestData.Rhodamine.NE,RestCriteria);
        [puffLogical] = FilterEvents_IOS(RestData.Rhodamine.NE,RestPuffCriteria);
        combRestLogical = logical(restLogical.*puffLogical);
        restFileIDs = RestData.Rhodamine.NE.fileIDs(combRestLogical,:);
        restEventTimes = RestData.Rhodamine.NE.eventTimes(combRestLogical,:);
        restDurations = RestData.Rhodamine.NE.durations(combRestLogical,:);
        restData = RestData.Rhodamine.NE.data(combRestLogical,:);
    elseif strcmp(dataType,'Ach_GFP') == true
        [restLogical] = FilterEvents_IOS(RestData.GFP.Ach,RestCriteria);
        [puffLogical] = FilterEvents_IOS(RestData.GFP.Ach,RestPuffCriteria);
        combRestLogical = logical(restLogical.*puffLogical);
        restFileIDs = RestData.GFP.Ach.fileIDs(combRestLogical,:);
        restEventTimes = RestData.GFP.Ach.eventTimes(combRestLogical,:);
        restDurations = RestData.GFP.Ach.durations(combRestLogical,:);
        ...
        if sum(strcmp(scoringLabels,'Not Sleep')) > 144   % 36 bins (180 total) or 3 minutes of Asleep
            ...
            if strcmp(ProcData.data.Pupil.diameterCheck,'y') == true
                ...
                if isempty(puffs) == true
                    if strcmp(dataType,'Ach_Rhodamine') == true
                        awakeData{zz,1} = ProcData.data.Rhodamine.Ach;
                        zz = zz + 1;
                    elseif strcmp(dataType,'NE_Rhodamine') == true
                        awakeData{zz,1} = ProcData.data.Rhodamine.NE;
                        zz = zz + 1;
                    elseif strcmp(dataType,'Ach_GFP') == true
                        awakeData{zz,1} = ProcData.data.GFP.Ach;
                        zz = zz + 1;
                    elseif strcmp(dataType,'NE_GFP') == true
                        awakeData{zz,1} = ProcData.data.GFP.NE;
                        zz = zz + 1;
                    elseif strcmp(dataType,'RH_thetaBandPower') == true
    ...
    if strcmp(dataType,'Ach_Rhodamine') == true
        [nremData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
    elseif strcmp(dataType,'NE_Rhodamine') == true
        [nremData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
    elseif strcmp(dataType,'Ach_GFP') == true
        [nremData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
    elseif strcmp(dataType,'NE_GFP') == true
        [nremData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
    elseif strcmp(dataType,'RH_thetaBandPower') == true
    ...
    if isempty(SleepData.(modelType).REM.data.Pupil) == false
        if strcmp(dataType,'Ach_Rhodamine') == true
            [remData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
        elseif strcmp(dataType,'NE_Rhodamine') == true
            [remData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
        elseif strcmp(dataType,'Ach_GFP') == true
            [remData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
        elseif strcmp(dataType,'NE_GFP') == true
            [remData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
        elseif strcmp(dataType,'RH_thetaBandPower') == true
