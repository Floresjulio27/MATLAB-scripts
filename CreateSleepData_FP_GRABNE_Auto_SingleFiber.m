function [SleepData] = CreateSleepData_FP_GRABNE_Auto_SingleFiber(startingDirectory,trainingDirectory,baselineDirectory,NREMsleepTime,REMsleepTime,modelName,SleepData)
