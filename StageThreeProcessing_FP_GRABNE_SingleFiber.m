function StageThreeProcessing_FP_GRABNE_SingleFiber()
...
dataTypes = {'Rhodamine','GFP','cortical_LH','EMG','Pupil'};
neuralDataTypes = {'cortical_LH'};
...
[RestData] = ExtractRestingData_FP_GRABNE_SingleFiber(procDataFileIDs,dataTypes);
...
[EventData] = ExtractEventTriggeredData_FP_GRABNE_SingleFiber(procDataFileIDs,dataTypes);
...
[RestData] = ExtractRestingData_FP_Pupil_GRABNE_SingleFiber(procDataFileIDs,dataTypes);
% add pupil area to EventData.mat
[EventData] = ExtractEventTriggeredData_FP_Pupil_GRABNE_SingleFiber(procDataFileIDs,dataTypes);
...
for bb = 1:size(procDataFileIDs,1)
    ...
    [figHandle] = GenerateSingleFigures_FP_GRABNE_SingleFiber(procDataFileID,saveFigs);
    close(figHandle)
end
