function [] = MainScript_SST_NewVersion()
%%
clear; clc; close all;
%% Animal IDs
%FP_animalIDs =    {'NEACh011','NEACh009','NEACh010'};%,'NEAChGi001','NEAChGi002','NEAChChR2002'};
FP_animalIDs = {'JF098'};
%FP_animalIDs = {'JF048','JF050','JF054'};
%FP_animalIDs = {'JF051','JF068','JF072'};
%FP_animalIDs = {'JF051','JF072'};
%FP_animalIDs = {'JF045','JF046'};
%FP_animalIDs = {'JF051','JF068','JF072','JF073','JF067'};%PFC_PL
%FP_animalIDs = {'JF048','JF050','JF054','JF067'}; %PFC_Caudal
%FP_animalIDs = {'JF048','JF050','JF051','JF054','JF067','JF068','JF072','JF073'}; %S1BF
%FP_animalIDs = {'JF048','JF050','JF051','JF054','JF067','JF068','JF072'};
%FP_animalIDs = {'JF037','JF038','JF039','JF050','JF048'};
%FP_animalIDs = {'JF037','JF039','JF040','JF050','JF048'};
%FP_animalIDs = {'JF037','JF038','JF039','JF048','JF050'};
%FP_animalIDs = {'JF037','JF040'};
%FP_animalIDs = {'JF051','JF054','JF072','JF073','JF068','JF067'};
%FP_animalIDs = {'JF051','JF067','JF073'};
%FP_animalIDs = {'JF037','JF038','JF039','JF040'}; %etoh cohort 1
...
%% Kevin's figures of interest 
% [AnalysisResults] = Fig2(rootFolder,saveFigs,delim,AnalysisResults);

%% SST functions
%[AnalysisResults] = Figures_Sleep_SST(rootFolder,saveFigs,delim,AnalysisResults);

[AnalysisResults] = Fig1_S2_Stim_SST_ResponseIndividual_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
%[AnalysisResults] = Fig1_S3_Whisk_SST_Response_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
%[AnalysisResults] = Fig1_S2_Stim_Response_SEM_Shak_JF(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FPanimalIDs)
...
%[AnalysisResults] = Transition_SST_SingleMouse_consolidated_CI_S1BF_FP(rootFolder, saveFigs, delim, AnalysisResults, firstHrs, FP_animalIDs);
%[AnalysisResults] = Transition_SST_SingleMouse_consolidated_CI_PFC_FP_onlySST(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);

%[AnalysisResults] = PlotCrossCorrelation_SST_RNR(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
%[AnalysisResults] = PlotCrossCorrelation_SST_AAA(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
...
% end
%% Block [4] Analyze the hemodynamic signal [HbT] during different arousal states. CBV mean
% runFromStart = 'y';
...
% end
%% Block [5] Analyze the GFP signal during different arousal states. GCaMP mean 
% runFromStart = 'y';
% for ff = 1:length(FP_animalIDs)
...
% end
%% Block [6] Analyze the stimulus-evoked and whisking-evoked neural/hemodynamic responses (IOS). Whisker Puff
runFromStart = 'y';
...
%           [AnalysisResults] = AnalyzeCrossCorrelation_DataDivision_SST(FP_animalIDs{1,nn},rootFolder,AnalysisResults,firstHrs);
%     end
