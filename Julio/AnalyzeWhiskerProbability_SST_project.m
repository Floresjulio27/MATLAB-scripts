...
% append (add to the end) with offset
...
whiskMat   = allWhiskSwitches(sampleIdx)'; %This the raw data of probability of whisking 15seconds before stim and 15s afte. Only contralateral stimulation PFC
   

% % Compute probability in ±15 s window. This is is you want to calculate
% the mean
% Ntrials  = numel(allStimSamples);
% preCount  = 0;
% postCount = 0;
...
Results_WhiskerProbability.(group).(days).(animalID).TimeVector  = timeVec;
