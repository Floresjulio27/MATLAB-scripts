function [] = Fig_Stim_SST_ResponseIndividual_Water(rootFolder,saveState,delim)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% This code was originaally written by Dr. Kevin L. Turner, modified by MD
...
CBV_Day3_color = [0.42, 0.56, 0.14];
CBV_Day4_color = [0.70, 1.00, 1.0];
CBV_Day5_color = [0.55, 0.45, 0.70];
CBV_Day6_color = [0.42, 0.56, 0.14];

%% Contra stim PFC fiber GFP (Right hemisphere, left whisker stim) -
ax1 = subplot(2,2,1);
sgtitle('Stimulus Evoked Responses(Water Group)')

% GFP day 1
x = data.Water.Day1.GetTimeVector.Contra.mean_timeVector (:)';
y = data.Water.Day1.Contra.P_NEGFP_Mean(:)';
e = data.Water.Day1.Contra.P_NEGFP_SEM(:)';
fill([x fliplr(x)], [y+e fliplr(y-e)], gfp_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
hold on;
p1 = plot(x, y, 'Color', gfp_Day1_color, 'LineWidth', 2);

% GFP day 2 
x2 = data.Water.Day2.GetTimeVector.Contra.mean_timeVector(:)';
y2 = data.Water.Day2.Contra.P_NEGFP_Mean(:)';
e2 = data.Water.Day2.Contra.P_NEGFP_SEM(:)';
...
% GFP day 3 
x3 = data.Water.Day3.GetTimeVector.Contra.mean_timeVector(:)';
y3 = data.Water.Day3.Contra.P_NEGFP_Mean(:)';
e3 = data.Water.Day3.Contra.P_NEGFP_SEM(:)';
...
% GFP day 4 
x4 = data.Water.Day4.GetTimeVector.Contra.mean_timeVector(:)';
y4 = data.Water.Day4.Contra.P_NEGFP_Mean(:)';
e4 = data.Water.Day4.Contra.P_NEGFP_SEM(:)';
...
% GFP day 5 
x5 = data.Water.Day5.GetTimeVector.Contra.mean_timeVector(:)';
y5 = data.Water.Day5.Contra.P_NEGFP_Mean(:)';
e5 = data.Water.Day5.Contra.P_NEGFP_SEM(:)';
...
% % GFP day 6
% x6 = data.Water.Day6.GetTimeVector.Contra.mean_timeVector(:)';
% y6 = data.Water.Day6.Contra.P_NEGFP_Mean(:)';
% e6 = data.Water.Day6.Contra.P_NEGFP_SEM(:)';
...
xlabel('Time (s)')
%legend([p1 p2 p3 p4 p5 p6],'Week1','Week2','Week3','Week4','Week5','Week6')
...
% CBV day 1
x = data.Water.Day1.GetTimeVector.Contra.mean_timeVector (:)';
y = data.Water.Day1.Contra.P_NECBV_Mean(:)';
e = data.Water.Day1.Contra.P_NECBV_SEM(:)';
...
% CBV day 2 
x2 = data.Water.Day2.GetTimeVector.Contra.mean_timeVector(:)';
y2 = data.Water.Day2.Contra.P_NECBV_Mean(:)';
e2 = data.Water.Day2.Contra.P_NECBV_SEM(:)';
...
% CBV day 3 
x3 = data.Water.Day3.GetTimeVector.Contra.mean_timeVector(:)';
y3 = data.Water.Day3.Contra.P_NECBV_Mean(:)';
e3 = data.Water.Day3.Contra.P_NECBV_SEM(:)';
...
% CBV day 4 
x4 = data.Water.Day4.GetTimeVector.Contra.mean_timeVector(:)';
y4 = data.Water.Day4.Contra.P_NECBV_Mean(:)';
e4 = data.Water.Day4.Contra.P_NECBV_SEM(:)';
...
% CBV day 5 
x5 = data.Water.Day5.GetTimeVector.Contra.mean_timeVector(:)';
y5 = data.Water.Day5.Contra.P_NECBV_Mean(:)';
e5 = data.Water.Day5.Contra.P_NECBV_SEM(:)';
...
% % CBV day 6
% x6 = data.Water.Day6.GetTimeVector.Contra.mean_timeVector(:)';
% y6 = data.Water.Day6.Contra.P_NECBV_Mean(:)';
% e6 = data.Water.Day6.Contra.P_NECBV_SEM(:)';
...
% GFP day 1
x = data.Water.Day1.GetTimeVector.Contra.mean_timeVector (:)';
y = data.Water.Day1.Contra.P_AChGFP_Mean(:)';
e = data.Water.Day1.Contra.P_AChGFP_SEM(:)';
fill([x fliplr(x)], [y+e fliplr(y-e)], gfp_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
hold on;
p1 = plot(x, y, 'Color', gfp_Day1_color, 'LineWidth', 2);
...
% GFP day 2 
x2 = data.Water.Day2.GetTimeVector.Contra.mean_timeVector(:)';
y2 = data.Water.Day2.Contra.P_AChGFP_Mean(:)';
e2 = data.Water.Day2.Contra.P_AChGFP_SEM(:)';
fill([x2 fliplr(x2)], [y2+e2 fliplr(y2-e2)], gfp_Day2_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p2 = plot(x2, y2, 'Color', gfp_Day2_color, 'LineWidth', 2);

% GFP day 3 
x3 = data.Water.Day3.GetTimeVector.Contra.mean_timeVector(:)';
y3 = data.Water.Day3.Contra.P_AChGFP_Mean(:)';
e3 = data.Water.Day3.Contra.P_AChGFP_SEM(:)';
fill([x3 fliplr(x3)], [y3+e3 fliplr(y3-e3)], gfp_Day3_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p3 = plot(x3, y3, 'Color', gfp_Day3_color, 'LineWidth', 2);

% GFP day 4 
x4 = data.Water.Day4.GetTimeVector.Contra.mean_timeVector(:)';
y4 = data.Water.Day4.Contra.P_AChGFP_Mean(:)';
e4 = data.Water.Day4.Contra.P_AChGFP_SEM(:)';
fill([x4 fliplr(x4)], [y4+e4 fliplr(y4-e4)], gfp_Day4_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p4 = plot(x4, y4, 'Color', gfp_Day4_color, 'LineWidth', 2);

% GFP day 5 
x5 = data.Water.Day5.GetTimeVector.Contra.mean_timeVector(:)';
y5 = data.Water.Day5.Contra.P_AChGFP_Mean(:)';
e5 = data.Water.Day5.Contra.P_AChGFP_SEM(:)';
fill([x5 fliplr(x5)], [y5+e5 fliplr(y5-e5)], gfp_Day5_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p5 = plot(x5, y5, 'Color', gfp_Day5_color, 'LineWidth', 2);

% % GFP day 6
% x6 = data.Water.Day6.GetTimeVector.Contra.mean_timeVector(:)';
% y6 = data.Water.Day6.Contra.P_AChGFP_Mean(:)';
% e6 = data.Water.Day6.Contra.P_AChGFP_SEM(:)';
% fill([x6 fliplr(x6)], [y6+e6 fliplr(y6-e6)], gfp_Day6_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
% p6 = plot(x6, y6, 'Color', gfp_Day6_color, 'LineWidth', 2);
...
% CBV day 1
x = data.Water.Day1.GetTimeVector.Contra.mean_timeVector (:)';
y = data.Water.Day1.Contra.P_AChCBV_Mean(:)';
e = data.Water.Day1.Contra.P_AChCBV_SEM(:)';
fill([x fliplr(x)], [y+e fliplr(y-e)], CBV_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
hold on;
p1 = plot(x, y, 'Color', CBV_Day1_color, 'LineWidth', 2);
...
% CBV day 2 
x2 = data.Water.Day2.GetTimeVector.Contra.mean_timeVector(:)';
y2 = data.Water.Day2.Contra.P_AChCBV_Mean(:)';
e2 = data.Water.Day2.Contra.P_AChCBV_SEM(:)';
fill([x2 fliplr(x2)], [y2+e2 fliplr(y2-e2)], CBV_Day2_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p2 = plot(x2, y2, 'Color', CBV_Day2_color, 'LineWidth', 2);

% CBV day 3 
x3 = data.Water.Day3.GetTimeVector.Contra.mean_timeVector(:)';
y3 = data.Water.Day3.Contra.P_AChCBV_Mean(:)';
e3 = data.Water.Day3.Contra.P_AChCBV_SEM(:)';
fill([x3 fliplr(x3)], [y3+e3 fliplr(y3-e3)], CBV_Day3_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p3 = plot(x3, y3, 'Color', CBV_Day3_color, 'LineWidth', 2);

% CBV day 4 
x4 = data.Water.Day4.GetTimeVector.Contra.mean_timeVector(:)';
y4 = data.Water.Day4.Contra.P_AChCBV_Mean(:)';
e4 = data.Water.Day4.Contra.P_AChCBV_SEM(:)';
fill([x4 fliplr(x4)], [y4+e4 fliplr(y4-e4)], CBV_Day4_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p4 = plot(x4, y4, 'Color', CBV_Day4_color, 'LineWidth', 2);

% CBV day 5 
x5 = data.Water.Day5.GetTimeVector.Contra.mean_timeVector(:)';
y5 = data.Water.Day5.Contra.P_AChCBV_Mean(:)';
e5 = data.Water.Day5.Contra.P_AChCBV_SEM(:)';
fill([x5 fliplr(x5)], [y5+e5 fliplr(y5-e5)], CBV_Day5_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p5 = plot(x5, y5, 'Color', CBV_Day5_color, 'LineWidth', 2);

% % CBV day 6
% x6 = data.Water.Day6.GetTimeVector.Contra.mean_timeVector(:)';
% y6 = data.Water.Day6.Contra.P_AChCBV_Mean(:)';
% e6 = data.Water.Day6.Contra.P_AChCBV_SEM(:)';
% fill([x6 fliplr(x6)], [y6+e6 fliplr(y6-e6)], CBV_Day6_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
% p6 = plot(x6, y6, 'Color', CBV_Day6_color, 'LineWidth', 2);
...
if saveState == true
    ...
    savefig(fullfile(dirpath, 'Stimulus_Evoked_Responses_Water'));
end
