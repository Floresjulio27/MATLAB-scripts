function [] = Fig_Stim_SST_ResponseIndividual_Alcohol(rootFolder,saveState,delim)
...
ax1 = subplot(2,2,1);
sgtitle('Stimulus Evoked Responses(Alcohol Group)')
...
if saveState == true
    ...
    savefig(fullfile(dirpath, 'Stimulus_Evoked_Responses_Alcohol'));
end
