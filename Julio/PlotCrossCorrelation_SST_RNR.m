function [AnalysisResults] = PlotCrossCorrelation_SST_RNR(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,animalIDs)
%% cross correlation
...
for bb = 1:length(dataTypes)
        ...
        sgtitle ('CrossCorrelation in different arousal stages')
