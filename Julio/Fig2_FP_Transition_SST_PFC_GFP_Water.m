function [] = Fig2_FP_Transition_SST_PFC_GFP_Water(rootFolder,saveState,delim)
...
sgtitle('ArousalStateTransition SST PFC GFP Water')
ax1 = subplot(2,2,1);
...
if saveState == true
    ...
    savefig(fullfile(dirpath, 'ArousalStateTransition_SST_PFC_GFP_Water'));
end
