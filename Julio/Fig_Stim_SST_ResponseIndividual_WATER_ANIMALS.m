function [] = Fig_Stim_SST_ResponseIndividual_WATER_ANIMALS(rootFolder,saveState,delim)
...
ax1 = subplot(2,2,1);
sgtitle('Stimulus Evoked Responses(Water Group) ANIMALS')
...
if saveState == true
    ...
    savefig(fullfile(dirpath, 'Stimulus_Evoked_Responses_Water_ANIMALS'));
end
