function [AnalysisResults] = AnalyzeEvokedResponses_SST_Water(animalID,rootFolder,AnalysisResults,firstHrs)
...
%% analyze whisking-evoked responses
    ...
    if firstHrs == "false"
        for bb = 1:length(WhiskCriteriaNames)
            ...
            % save results
            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).CBV.CBV = AChmeanWhiskCBVData;
            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).CBV.CBVStD = AChstdWhiskCBVData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).CBV.CBV = NEmeanWhiskCBVData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).CBV.CBVStD = NEstdWhiskCBVData;
    
            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).GFP.GFP = AChmeanWhiskGFPData;
            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).GFP.GFPStD = AChstdWhiskGFPData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).GFP.GFP = NEmeanWhiskGFPData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).GFP.GFPStD = NEstdWhiskGFPData;

            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).CBV.CBVRaw = AChprocWhiskCBVData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).CBV.CBVRaw = NEprocWhiskCBVData;
    
            AnalysisResults.(animalID).Water.Whisk.P_ACh.(whiskCriteriaName).GFP.GFPRaw = AChprocWhiskGFPData;
            AnalysisResults.(animalID).Water.Whisk.P_NE.(whiskCriteriaName).GFP.GFPRaw = NEprocWhiskGFPData;

    
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).MUA.corticalData = meanWhiskCorticalMUAData;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).MUA.corticalStD = stdWhiskCorticalMUAData;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).Gam.corticalData = meanWhiskCorticalGamData;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).Gam.corticalStD = stdWhiskCorticalGamData;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).timeVector = timeVector;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).LFP.corticalS = msStimWhiskS_Vals;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).LFP.T = T2;
            AnalysisResults.(animalID).Water.Whisk.cortical.(whiskCriteriaName).LFP.F = F;
        end
    end
