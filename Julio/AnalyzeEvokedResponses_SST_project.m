...
movementCriteriaA.Value = {1,5,5};  %original = {2.5,5,5} I change greater to 1 to span more events JF
...
%% analyze whisking-evoked responses
    ...
    for gg = 1:length(stimCriteriaNames)
            ...
            % pull data from EventData.mat structure and skip the ones that
            % do not have 
