function [AnalysisResults] = Fig1_S3_Whisk_SST_Response_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,animalIDs)
...
% pC = plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.P_CBV_Mean,'-','color','red','LineWidth',2);
% hold on
...
%legend([p3, p4,pq,pC],'ACh', 'NE','ACh-NE','CBV')
legend([p1, p2, p3, p4],'CBV-S1BF','CBV-PFC', 'SST S1BF', 'SST PFC')
