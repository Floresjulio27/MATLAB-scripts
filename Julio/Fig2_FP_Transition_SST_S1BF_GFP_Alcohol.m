function [] = Fig2_FP_Transition_SST_S1BF_GFP_Alcohol(rootFolder,saveState,delim)
...
%SST Ca2+ activity in S1BF/Alcohol

sgtitle('ArousalStateTransition SST S1BF GFP Alcohol pooled')

ax1 = subplot(2,2,1);

% GFP day 1
x = T1;
y = data.Alcohol.Day1.AWAKEtoNREM.P_AChGFP_Mean;
e = data.Alcohol.Day1.AWAKEtoNREM.P_AChGFP_SEM;
hold on
...
% GFP day 2 
x2 = T1;
y2 = data.Alcohol.Day2.AWAKEtoNREM.P_AChGFP_Mean;
e2 = data.Alcohol.Day2.AWAKEtoNREM.P_AChGFP_SEM;
...
% GFP day 3
x3 = T1;
y3 = data.Alcohol.Day3.AWAKEtoNREM.P_AChGFP_Mean;
e3 = data.Alcohol.Day3.AWAKEtoNREM.P_AChGFP_SEM;
...
% GFP day 4 
x4 = T1;
y4 = data.Alcohol.Day4.AWAKEtoNREM.P_AChGFP_Mean;
e4 = data.Alcohol.Day4.AWAKEtoNREM.P_AChGFP_SEM;
...
% GFP day 5
x5 = T1;
y5 = data.Alcohol.Day5.AWAKEtoNREM.P_AChGFP_Mean;
e5 = data.Alcohol.Day5.AWAKEtoNREM.P_AChGFP_SEM;
...
% GFP day 6 
% x6 = T1;
% y6 = data.Alcohol.Day6.AWAKEtoNREM.P_AChGFP_Mean;
% e6 = data.Alcohol.Day6.AWAKEtoNREM.P_AChGFP_SEM;
...
% GFP day 1
x = T1;
y = data.Alcohol.Day1.NREMtoAWAKE.P_AChGFP_Mean;
e = data.Alcohol.Day1.NREMtoAWAKE.P_AChGFP_SEM;
hold on
fill([x fliplr(x)], [y+e fliplr(y-e)], gfp_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p1 = plot(x, y, 'Color', gfp_Day1_color, 'LineWidth', 2);
...
% GFP day 2 
x2 = T1;
y2 = data.Alcohol.Day2.NREMtoAWAKE.P_AChGFP_Mean;
e2 = data.Alcohol.Day2.NREMtoAWAKE.P_AChGFP_SEM;
fill([x2 fliplr(x2)], [y2+e2 fliplr(y2-e2)], gfp_Day2_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p2 = plot(x2, y2, 'Color', gfp_Day2_color, 'LineWidth', 2);

% GFP day 3
x3 = T1;
y3 = data.Alcohol.Day3.NREMtoAWAKE.P_AChGFP_Mean;
e3 = data.Alcohol.Day3.NREMtoAWAKE.P_AChGFP_SEM;
fill([x3 fliplr(x3)], [y3+e3 fliplr(y3-e3)], gfp_Day3_color,'FaceAlpha', 0.3, 'EdgeColor', 'none'); 
p3 = plot(x3, y3, 'Color', gfp_Day3_color, 'LineWidth', 2);

% GFP day 4 
x4 = T1;
y4 = data.Alcohol.Day4.NREMtoAWAKE.P_AChGFP_Mean;
e4 = data.Alcohol.Day4.NREMtoAWAKE.P_AChGFP_SEM;
fill([x4 fliplr(x4)], [y4+e4 fliplr(y4-e4)], gfp_Day4_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p4 = plot(x4, y4, 'Color', gfp_Day4_color, 'LineWidth', 2);

% GFP day 5
x5 = T1;
y5 = data.Alcohol.Day5.NREMtoAWAKE.P_AChGFP_Mean;
e5 = data.Alcohol.Day5.NREMtoAWAKE.P_AChGFP_SEM;
fill([x5 fliplr(x5)], [y5+e5 fliplr(y5-e5)], gfp_Day5_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p5 = plot(x5, y5, 'Color', gfp_Day5_color, 'LineWidth', 2);

% GFP day 6 
% x6 = T1;
% y6 = data.Alcohol.Day6.NREMtoAWAKE.P_AChGFP_Mean;
% e6 = data.Alcohol.Day6.NREMtoAWAKE.P_AChGFP_SEM;
% fill([x6 fliplr(x6)], [y6+e6 fliplr(y6-e6)], gfp_Day6_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
% p6 = plot(x6, y6, 'Color', gfp_Day6_color, 'LineWidth', 2);
...
% GFP day 1
x = T1;
y = data.Alcohol.Day1.NREMtoREM.P_AChGFP_Mean;
e = data.Alcohol.Day1.NREMtoREM.P_AChGFP_SEM;
hold on
fill([x fliplr(x)], [y+e fliplr(y-e)], gfp_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p1 = plot(x, y, 'Color', gfp_Day1_color, 'LineWidth', 2);
...
% GFP day 2 
x2 = T1;
y2 = data.Alcohol.Day2.NREMtoREM.P_AChGFP_Mean;
e2 = data.Alcohol.Day2.NREMtoREM.P_AChGFP_SEM;
fill([x2 fliplr(x2)], [y2+e2 fliplr(y2-e2)], gfp_Day2_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p2 = plot(x2, y2, 'Color', gfp_Day2_color, 'LineWidth', 2);

% GFP day 3
x3 = T1;
y3 = data.Alcohol.Day3.NREMtoREM.P_AChGFP_Mean;
e3 = data.Alcohol.Day3.NREMtoREM.P_AChGFP_SEM;
fill([x3 fliplr(x3)], [y3+e3 fliplr(y3-e3)], gfp_Day3_color,'FaceAlpha', 0.3, 'EdgeColor', 'none'); 
p3 = plot(x3, y3, 'Color', gfp_Day3_color, 'LineWidth', 2);

% GFP day 4 
x4 = T1;
y4 = data.Alcohol.Day4.NREMtoREM.P_AChGFP_Mean;
e4 = data.Alcohol.Day4.NREMtoREM.P_AChGFP_SEM;
fill([x4 fliplr(x4)], [y4+e4 fliplr(y4-e4)], gfp_Day4_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p4 = plot(x4, y4, 'Color', gfp_Day4_color, 'LineWidth', 2);

% GFP day 5
x5 = T1;
y5 = data.Alcohol.Day5.NREMtoREM.P_AChGFP_Mean;
e5 = data.Alcohol.Day5.NREMtoREM.P_AChGFP_SEM;
fill([x5 fliplr(x5)], [y5+e5 fliplr(y5-e5)], gfp_Day5_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p5 = plot(x5, y5, 'Color', gfp_Day5_color, 'LineWidth', 2);

% GFP day 6 
% x6 = T1;
% y6 = data.Alcohol.Day6.NREMtoREM.P_AChGFP_Mean;
% e6 = data.Alcohol.Day6.NREMtoREM.P_AChGFP_SEM;
% fill([x6 fliplr(x6)], [y6+e6 fliplr(y6-e6)], gfp_Day6_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
% p6 = plot(x6, y6, 'Color', gfp_Day6_color, 'LineWidth', 2);
...
% GFP day 1
x = T1;
y = data.Alcohol.Day1.REMtoAWAKE.P_AChGFP_Mean;
e = data.Alcohol.Day1.REMtoAWAKE.P_AChGFP_SEM;
hold on
fill([x fliplr(x)], [y+e fliplr(y-e)], gfp_Day1_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p1 = plot(x, y, 'Color', gfp_Day1_color, 'LineWidth', 2);
...
% GFP day 2 
x2 = T1;
y2 = data.Alcohol.Day2.REMtoAWAKE.P_AChGFP_Mean;
e2 = data.Alcohol.Day2.REMtoAWAKE.P_AChGFP_SEM;
fill([x2 fliplr(x2)], [y2+e2 fliplr(y2-e2)], gfp_Day2_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p2 = plot(x2, y2, 'Color', gfp_Day2_color, 'LineWidth', 2);

% GFP day 3
x3 = T1;
y3 = data.Alcohol.Day3.REMtoAWAKE.P_AChGFP_Mean;
e3 = data.Alcohol.Day3.REMtoAWAKE.P_AChGFP_SEM;
fill([x3 fliplr(x3)], [y3+e3 fliplr(y3-e3)], gfp_Day3_color,'FaceAlpha', 0.3, 'EdgeColor', 'none'); 
p3 = plot(x3, y3, 'Color', gfp_Day3_color, 'LineWidth', 2);

% GFP day 4 
x4 = T1;
y4 = data.Alcohol.Day4.REMtoAWAKE.P_AChGFP_Mean;
e4 = data.Alcohol.Day4.REMtoAWAKE.P_AChGFP_SEM;
fill([x4 fliplr(x4)], [y4+e4 fliplr(y4-e4)], gfp_Day4_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
p4 = plot(x4, y4, 'Color', gfp_Day4_color, 'LineWidth', 2);

% GFP day 5
x5 = T1;
y5 = data.Alcohol.Day5.REMtoAWAKE.P_AChGFP_Mean;
e5 = data.Alcohol.Day5.REMtoAWAKE.P_AChGFP_SEM;
fill([x5 fliplr(x5)], [y5+e5 fliplr(y5-e5)], gfp_Day5_color,'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
p5 = plot(x5, y5, 'Color', gfp_Day5_color, 'LineWidth', 2);

% GFP day 6 
% x6 = T1;
% y6 = data.Alcohol.Day6.REMtoAWAKE.P_AChGFP_Mean;
% e6 = data.Alcohol.Day6.REMtoAWAKE.P_AChGFP_SEM;
% fill([x6 fliplr(x6)], [y6+e6 fliplr(y6-e6)], gfp_Day6_color,'FaceAlpha', 0.2, 'EdgeColor', 'none');
% p6 = plot(x6, y6, 'Color', gfp_Day6_color, 'LineWidth', 2);
...
if saveState == true
    ...
    savefig(fullfile(dirpath, 'ArousalStateTransition_SST_S1BF_GFP_Alcohol_pooled'));
end