...
% Rhodamine_meanTable = table('Size',[size(tableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Hemisphere','Behavior','Median'});
...
% Rhodamine_meanFitFormula = 'Median ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
...
% GFP_meanTable = table('Size',[size(tableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Hemisphere','Behavior','Median'});
...
% GFP_meanFitFormula = 'Median ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
% GFP_meanStats = fitglme(GFP_meanTable,GFP_meanFitFormula)

%% Fig. 1-S4
summaryFigure = figure('Name','Fig1-S5 Stats');
sgtitle('Median hemodynamic changes')
%% Mean Rhodamine Ach
ax1 = subplot(2,2,1);
