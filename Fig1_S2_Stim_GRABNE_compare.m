function [AnalysisResults] = Fig1_S2_Stim_GRABNE_compare(rootFolder,saveFigs,delim,AnalysisResults,firstHrs)
...
sgtitle('Stimulus evoked responses before and after trazodone injection')
...
plot(data.Contra.mean_timeVector,data.Contra.Z_NEmean_Rhodamine - data.Contra.Z_NEmean_Rhodamine_std,'-','color',[0.6350 0.0780 0.1840],'LineWidth',0.10)
title('Without Trazodone Injection')
ylabel('\DeltaF/F (Z)')
ax2.YLim = [-7 8];
...
legend([p1,p2,p3],'CBV','NE', 'ACh','Location','best')
axis square
set(gca,'box','off')
...
% plot
ax2 = subplot(2,3,2);
p1= plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_Rhodamine,'-','color',[0.6350 0.0780 0.1840],'LineWidth',2);
hold on
plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_Rhodamine + tradozone_data.Contra.Z_NEmean_Rhodamine_std,'-','color',[0.6350 0.0780 0.1840],'LineWidth',0.10)
plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_Rhodamine - tradozone_data.Contra.Z_NEmean_Rhodamine_std,'-','color',[0.6350 0.0780 0.1840],'LineWidth',0.10)
title('With Trazodone Injection')
ylabel('\DeltaF/F (Z)')
ax2.YLim = [-7 8];

% yyaxis right
p2 = plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_GFP,'-','color',[0.4660 0.6740 0.1880],'LineWidth',2);
hold on
plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_GFP + tradozone_data.Contra.Z_NEmean_GFP_std,'-','color',[0.4660 0.6740 0.1880],'LineWidth',0.10)
plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_GFP - tradozone_data.Contra.Z_NEmean_GFP_std,'-','color',[0.4660 0.6740 0.1880],'LineWidth',0.10)

p3 = plot(tradozone_data.Ipsi.mean_timeVector,tradozone_data.Ipsi.Z_Achmean_GFP,'-','color',[0 0.4470 0.7410],'LineWidth',2);
plot(tradozone_data.Ipsi.mean_timeVector,tradozone_data.Ipsi.Z_Achmean_GFP + tradozone_data.Ipsi.Z_Achmean_GFP_std,'-','color',[0 0.4470 0.7410],'LineWidth',0.10)
plot(tradozone_data.Ipsi.mean_timeVector,tradozone_data.Ipsi.Z_Achmean_GFP - tradozone_data.Ipsi.Z_Achmean_GFP_std,'-','color',[0 0.4470 0.7410],'LineWidth',0.10)
ylabel('\DeltaF/F (Z)')
ax2.YAxis(1).Color = 'k';
% ax2.YAxis(2).Color = 'k';
...
% hold on
% plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_Achmean_Rhodamine,'-','color',colors('electric purple'),'LineWidth',2)
% 
...
% hold on
% plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_Achmean_GFP,'-','color',colors('international klein blue'),'LineWidth',2)
% 
...
% ax1.YLim = [-3 6];
% xlim([-5 10])
% legend('CBV','CBV-T','ACh','ACh-T','Location','best')
% 
% % NE contra stim
% ax4 = subplot(2,3,4);
% plot(data.Contra.mean_timeVector,data.Contra.Z_NEmean_Rhodamine,'-','color',colors('indian red'),'LineWidth',2)
% hold on
% plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_Rhodamine,'-','color',colors('electric purple'),'LineWidth',2)
% 
...
% hold on
% plot(tradozone_data.Contra.mean_timeVector,tradozone_data.Contra.Z_NEmean_GFP,'-','color',colors('international klein blue'),'LineWidth',2)
% 
...
% ax4.YLim = [-3 6];
% xlim([-5 10])
% legend('CBV','CBV-T','NE','NE-T','Location','best')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigureN,[dirpath 'Fig1-S2-Stim-FiberSignals_compare']);
    set(summaryFigureN,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath 'Fig1-S2-Stim-FiberSignals_compare'])
    close 
end
